...
class Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERMETA_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP User Meta', 'pop-usermeta')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Meta', 'pop-usermeta'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-usermeta')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-usermeta'),
            'https://github.com/leoloso/PoP',
            POP_USERMETA_POP_ENGINE_MIN_VERSION
        );
    }
